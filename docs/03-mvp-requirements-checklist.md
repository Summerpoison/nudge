...
- [ ] **REVIEW-FUNC-008** (Must) — Reminder/aktive Benachrichtigungen beziehen sich AUSSCHLIESSLICH auf die aktuell committeten Fokus-Tasks, nicht auf alle Tasks im System. *(Scope nach Schritt 10c präzisiert: gilt für den täglichen Checkpoint-Digest, REVIEW-FUNC-007, noch nicht gebaut. Weekly-Review-Mail und Buddy-Alert (ESC-FUNC-004) sind bewusst ausgenommen — ersterer ist die Bestandsaufnahme, aus der Fokus-Tasks erst gewählt werden, letzterer ist durch seine eigene Auslöseregel bereits selten/gravierend genug, dass eine Fokus-Tasks-Beschränkung eine blinde Stelle für vernachlässigte Nicht-Fokus-Tasks schaffen würde. Siehe `02b-eisenhower-buddy-design.md`, Nachtrag zu Abschnitt 3.)*
